...
public class RadialGraphView extends Display {
    ...
    public RadialGraphView(JPanel jpl,Graph g, String label) {
        ...
        m_edgeRenderer.setManageBounds(true);
        ...
        //DataColorAction ccp = new  DataColorAction("graph.nodes", m_label,Constants.NOMINAL, VisualItem.FILLCOLOR);
        //m_vis.putAction("ccp", ccp);
            
            
        ActionList look = new ActionList();
            look.add(new DataColorAction(treeNodes, m_label,Constants.NOMINAL, VisualItem.FILLCOLOR));
            look.add(new ColorAction(treeNodes, VisualItem.TEXTCOLOR, ColorLib.rgb(0,0,0)));
            look.add(new ColorAction(treeEdges, VisualItem.FILLCOLOR, ColorLib.gray(200)));
            look.add(new ColorAction(treeEdges, VisualItem.STROKECOLOR, ColorLib.gray(200)));
             m_vis.putAction("look", look);
             m_vis.run("look");
       ...
       // FontAction fonts = new FontAction(treeNodes,
        ...
        ForceDirectedLayout layoutAction = new ForceDirectedLayout(tree);
        ForceSimulator fsim = layoutAction.getForceSimulator();
        fsim.getForces()[0].setParameter(0, -80.2f);
        //m_vis.putAction("layoutAction", layoutAction);
        ...
        setSize(jpl.getSize());
        pan(jpl.getHeight()/2, jpl.getWidth()/3);
        setLocation(jpl.getHeight()/2, jpl.getWidth()/2);
    ...
    public static JPanel doit(JPanel jpl, Graph g, final String label) {
        // create a new radial tree view
        final RadialGraphView gview = new RadialGraphView(jpl,g, label);
        ...
        title.setFont(FontLib.getFont("Tahoma", Font.PLAIN, 11));
    ...
    public static class NodeColorAction extends ColorAction {
        public NodeColorAction(String group) {
            super(group, VisualItem.FILLCOLOR, ColorLib.rgba(200,200,200,0));
