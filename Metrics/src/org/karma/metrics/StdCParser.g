...
primaryExpr
        :       ID //{System.out.println("ciao1")}
        |       charConst //{System.out.println("ciao2")}
        |       intConst //{System.out.println("ciao3")}
        |       floatConst //{System.out.println("ciao4")}
        |       stringConst //{System.out.println("ciao5")}
