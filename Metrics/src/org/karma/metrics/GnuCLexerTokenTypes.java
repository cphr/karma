...
public interface GnuCLexerTokenTypes {
	...
	int LITERAL___complex = 144;
	int LITERAL___attribute = 145;
	int LITERAL___alignof = 146;
	int LITERAL___real = 147;
	int LITERAL___imag = 148;
	int LITERAL___extension__ = 149;
	int IntSuffix = 150;
	int NumberSuffix = 151;
	int IDMEAT = 152;
	int WideCharLiteral = 153;
	int WideStringLiteral = 154;
}
