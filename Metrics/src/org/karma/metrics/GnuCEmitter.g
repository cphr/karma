...
structOrUnionBody
        :       ( (ID LCURLY) => i1:ID lc1:LCURLY   {FunzioneCorrente.push(i1.getText());print( i1 ); print ( "{" ); tabs++; }
...
initializer
        :       #( n:NInitializer (initializerElementLabel)?  expr )
...
functionDef
        :   #( nome:NFunctionDef {flagFunzione=1; }
...
binaryOperator
        :       ASSIGN          {operazioniPendenti.push(1);}
...
unaryOperator
        :       BAND            {operazioniPendenti.push(31); 
                                 flag_puntamento=1;}
